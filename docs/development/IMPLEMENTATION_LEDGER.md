...
| M-B2 | Binance State Plane | IN PROGRESS — USDⓈ-M Futures UM selected; M-B2-A, M-B2-B, and M-B2-C `LOCAL_PASS` read-only market/state slices integrated; M-B2-D next |
