...
- status: `REMEDIATION_COMPLETE / PROVISIONAL`; exact remediation code head: `12f5e8f42239d0d53e720eae09704be522e1f7ab`; parent independent review verdict: `REVISE`; fresh exact-head review pending.
