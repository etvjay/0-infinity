...
| M-B6 | Full Runtime | LOCAL_PASS — reviewed candidate `5c51584826876fe344337b9a0c19b83b4bb84a74`; independent exact-head review `APPROVE`; focused RuntimeSupervisor `19/19`, focused OrderWriter `25/25`, full `444/444`, check/build/diff-check PASS; local/replay only, no live execution or production durability claim |
