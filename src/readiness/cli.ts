...
const artifactPath = ".local/evidence/ZO-BIN-MB8-demo-readiness.json";
const mcpPath = ".local/evidence/ZO-BIN-MCP-401-agentic-read-only.json";
const secretPath = ".local/evidence/ZO-BIN-MB8-secret-manifest.json";
const reasoningArtifactPath = ".local/evidence/ZO-BIN-MB8-reasoning-verifiability.json";
export async function writeDemoArtifact(): Promise<void> {
  ...
  await writeFile(".local/evidence/ZO-BIN-MB8-reasoning-approve.json", JSON.stringify(approveReceipt, null, 2) + "\n");
  await writeFile(".local/evidence/ZO-BIN-MB8-reasoning-refuse.json", JSON.stringify(refuseReceipt, null, 2) + "\n");
  await writeFile(".local/evidence/ZO-BIN-MB8-reasoning-approve.md", reasoningReceiptMarkdown(approveReceipt) + "\n");
